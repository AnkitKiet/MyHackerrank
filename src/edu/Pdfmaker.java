...
public class Pdfmaker {
    ...
    public static void main(String[] args) {
        ...
        Pdfmaker generateInvoice = new Pdfmaker();
        if (args.length < 1)
        {
   ...
   //         System.exit(1);
    ...
    private void createPDF (String pdfFilename){
        ...
        try {
            ...
            doc.addAuthor("Ankit Maurya");
            doc.addCreationDate();
            doc.addProducer();
            doc.addCreator("Buffet");
    ...
    private void generateLayout(Document doc, PdfContentByte cb)  {
        ...
        try {
            ...
            createHeadings(cb,422,743,"Transaction No.");
            ...
            //add the images
            Image companyLogo = Image.getInstance("src/edu/encryption-vpn.png");
    ...
    private void generateHeader(Document doc, PdfContentByte cb)  {
        ...
        try {
            ...
            createHeadings(cb,200,750,"Buffet");
            createHeadings(cb,200,735,"Virtual");
            createHeadings(cb,200,720,"Virtual 2");
            createHeadings(cb,200,705,"New Delhi, - 202020");
